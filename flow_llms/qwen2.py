...
from .qwen2_components import FlowQwen2DecoderLayer
from .utils import (
    cosmap,
    identity,
    constant_velocity_schedule,
    edm_velocity_schedule
)
...
class FlowQwen2Model(Qwen2Model, FlowLanguageModel):
    def __init__(
        self,
        config: Qwen2Config,
        flow_representation_space: str = 'mapping',
        flow_representation_dim: Optional[int] = None,
        flow_representation_num_layers: Optional[int] = None,
        flow_representation_normalize: bool = True,
        flow_representation_rescaling: Optional[
            Literal["div", "mult", "none"]] = None,
        noise_rescaling: float = 1.0,
        flow_to_lm_translation_depth: Optional[int] = None,
        flow_to_lm_hidden_size: Optional[int] = None,
        flow_to_lm_timestep_rescaling: Optional[float] = None,
        ...
        timestep_modulation_hidden_size: Optional[int] = None,
        guidance_modulation_num_classes: Optional[int] = None,
        ...
        ode_kwargs: Optional[dict] = dict(
            atol=1e-5,
            rtol=1e-5,
            method='midpoint'
        ),
        nstep_final_timestep: float = 1.0,
        nstep_x1_estimation: Literal["average", "sample"] = "average",
        nstep_normalize_x1_predictions: bool = False,
        nstep_clamp_predictions: bool = False,
        nstep_temperature_schedule: Optional[
            float | Callable | str] = None,
        nstep_guidance_parameter: Optional[float] = None,
    ):
    ...
    def forward(
        ...
        cached_final_hidden_states: Optional[torch.FloatTensor] = None,
...
class FlowQwen2ForCausalLM(Qwen2ForCausalLM):
    _tied_weights_keys = ["lm_head.weight"]

    def __init__(
        self,
        model_or_model_id: Qwen2ForCausalLM | str,
        base_params_to_freeze: Optional[
            Literal["all", "none"]] = None,
        model_loading_kwargs: Optional[dict] = None,
        default_generation_nstep: Optional[int] = None,
        noise_schedule: Literal[
            "cosmap", "identity"] | Callable = "identity",
        minimum_training_noise: Optional[float] = None,
        minimum_training_noise_units: Literal[
            "time", "stddev"] | Callable = "time",
        velocity_schedule: Literal[
        ...
        if isinstance(model_or_model_id, str):
            ...
            model: Qwen2ForCausalLM = model_or_model_id
    ...
    def compute_velocity(
        ...
        class_labels: torch.LongTensor = None,
        flow_representation_embeds: Optional[torch.FloatTensor] = None,
        attention_mask: Optional[torch.Tensor] = None,
        position_ids: Optional[torch.LongTensor] = None,
        past_key_values: Optional[Union[
            Cache, List[torch.FloatTensor]]] = None,
        ...
        normalize_x1_predictions: Optional[bool] = None,
        ...
        debug_labels: Optional[torch.LongTensor] = None,
        **model_kwargs,
    ):
    ...
    def nstep_inference(
        ...
        past_key_values: Optional[Union[
            Cache, List[torch.FloatTensor]]] = None,
        cached_final_hidden_states: Optional[torch.FloatTensor] = None,
        x1_estimation: Optional[
            Literal["average", "sample"]] = None,
        normalize_x1_predictions: Optional[bool] = None,
        clamp_predictions: Optional[bool] = None,
        temperature_schedule: Optional[float | Callable] = None,
        guidance_parameter: Optional[float] = None,
    ...
    def generate(
        ...
        **kwargs,
        ...
        generation_outputs = Qwen2ForCausalLM.generate(
            self=self,
            inputs=inputs,
